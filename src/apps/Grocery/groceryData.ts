...
export const MEAL_PRESETS: MealPreset[] = [
  ...
  { id: 'm31', name: '부대찌개', ingredients: ['스팸 통조림', '소시지', '김치', '두부', '라면 (봉지)', '대파', '양파'] },
  { id: 'm32', name: '육개장', ingredients: ['소 국거리', '대파', '고사리', '숙주나물', '고춧가루', '다진마늘'] },
  { id: 'm33', name: '청국장', ingredients: ['청국장', '두부', '애호박', '대파', '양파', '김치'] },
  { id: 'm34', name: '갈비찜', ingredients: ['소 갈비', '간장', '설탕', '당근', '무', '대파', '양파'] },
  { id: 'm35', name: '아구찜', ingredients: ['아구', '콩나물', '미나리', '고춧가루', '대파', '다진마늘'] },
  { id: 'm36', name: '감자탕', ingredients: ['돼지 등뼈', '감자', '우거지', '깻잎', '들깨가루', '대파'] },
  { id: 'm37', name: '동태찌개', ingredients: ['동태', '무', '두부', '대파', '고춧가루', '다진마늘'] },
  { id: 'm38', name: '떡국', ingredients: ['떡국떡', '소 국거리', '대파', '계란', '김', '다진마늘'] },
  { id: 'm39', name: '만둣국', ingredients: ['냉동만두', '소 국거리', '대파', '계란', '다진마늘'] },
  { id: 'm40', name: '해물파전', ingredients: ['쪽파', '해물믹스', '부침가루', '계란', '청양고추'] },
  { id: 'm41', name: '김치전', ingredients: ['김치', '부침가루', '돼지 앞다리살', '양파'] },
  { id: 'm42', name: '잡채', ingredients: ['당면', '시금치', '당근', '양파', '소고기', '간장'] },
  { id: 'm43', name: '갈비탕', ingredients: ['소 갈비', '대파', '당면', '무', '다진마늘'] },
  { id: 'm44', name: '설렁탕', ingredients: ['사골국물', '소고기', '대파', '소면', '소금'] },
  { id: 'm45', name: '닭가슴살 샐러드', ingredients: ['닭가슴살', '양상추', '토마토', '오이', '드레싱'] },
  
  // 양식
  { id: 'm46', name: '토마토 파스타', ingredients: ['스파게티면', '파스타소스(토마토)', '양파', '마늘', '베이컨', '양송이버섯'] },
  { id: 'm47', name: '크림 파스타', ingredients: ['스파게티면', '생크림', '우유', '베이컨', '마늘', '양송이버섯'] },
  { id: 'm48', name: '알리오 올리오', ingredients: ['스파게티면', '마늘', '올리브유', '페페론치노', '소금'] },
  { id: 'm49', name: '로제 파스타', ingredients: ['스파게티면', '토마토소스', '생크림', '새우', '양파', '마늘'] },
  { id: 'm50', name: '스테이크', ingredients: ['소 등심', '아스파라거스', '마늘', '버터', '올리브유'] },
  { id: 'm51', name: '함박스테이크', ingredients: ['다진 소고기', '다진 돼지고기', '양파', '빵가루', '계란', '스테이크소스'] },
  { id: 'm52', name: '돈까스', ingredients: ['돼지 등심', '밀가루', '계란', '빵가루', '식용유', '돈까스소스'] },
  { id: 'm53', name: '피자', ingredients: ['또띠아', '토마토소스', '모짜렐라 치즈', '양파', '베이컨', '피망'] },
  { id: 'm54', name: '리조또', ingredients: ['쌀', '생크림', '버섯', '양파', '마늘', '파마산 치즈'] },
  { id: 'm55', name: '감바스 알아히요', ingredients: ['새우', '마늘', '올리브유', '페페론치노', '바게트빵'] },
  { id: 'm56', name: '에그 베네딕트', ingredients: ['잉글리시 머핀', '계란', '베이컨', '홀랜다이즈 소스', '시금치'] },
  { id: 'm57', name: '프렌치 토스트', ingredients: ['식빵', '계란', '우유', '설탕', '버터', '메이플시럽'] },
  { id: 'm58', name: '치킨 샐러드', ingredients: ['닭가슴살', '양상추', '토마토', '오이', '샐러드 드레싱'] },
  { id: 'm59', name: '클럽 샌드위치', ingredients: ['식빵', '계란', '베이컨', '토마토', '양상추', '마요네즈'] },
  { id: 'm60', name: '수프', ingredients: ['양송이스프 가루', '우유', '크루통'] },
  { id: 'm61', name: '브런치 세트', ingredients: ['소시지', '베이컨', '계란', '식빵', '버터', '딸기잼'] },
  { id: 'm62', name: '맥앤치즈', ingredients: ['마카로니', '체다치즈', '우유', '버터', '밀가루'] },
  { id: 'm63', name: '라자냐', ingredients: ['라자냐 면', '토마토소스', '다진 소고기', '모짜렐라 치즈', '양파'] },
  
  // 중식
  { id: 'm64', name: '짜장면', ingredients: ['중화면', '춘장', '돼지고기', '양파', '양배추', '감자'] },
  { id: 'm65', name: '짬뽕', ingredients: ['중화면', '해물믹스', '돼지고기', '양파', '대파', '고춧가루'] },
  { id: 'm66', name: '탕수육', ingredients: ['돼지 등심', '전분가루', '식용유', '양파', '당근', '식초', '설탕'] },
  { id: 'm67', name: '마파두부', ingredients: ['두부', '다진 돼지고기', '두반장', '대파', '마늘', '고추기름'] },
  { id: 'm68', name: '깐풍기', ingredients: ['닭다리살', '전분가루', '대파', '마늘', '간장', '식초'] },
  { id: 'm69', name: '볶음짬뽕', ingredients: ['중화면', '해물믹스', '고춧가루', '대파', '양파', '고추기름'] },
  { id: 'm70', name: '양장피', ingredients: ['양장피 면', '오징어', '새우', '돼지고기', '오이', '겨자소스'] },
  { id: 'm71', name: '고추잡채', ingredients: ['피망', '돼지고기', '양파', '굴소스', '꽃빵'] },
  { id: 'm72', name: '유산슬', ingredients: ['해삼', '새우', '죽순', '표고버섯', '돼지고기', '굴소스'] },
  { id: 'm73', name: '짬뽕밥', ingredients: ['즉석밥', '해물믹스', '돼지고기', '양파', '대파', '고춧가루'] },
  { id: 'm74', name: '군만두', ingredients: ['냉동만두', '식용유', '간장', '식초'] },
  
  // 일식 & 아시안
  { id: 'm75', name: '우동', ingredients: ['우동면', '우동다시', '대파', '어묵', '쑥갓'] },
  { id: 'm76', name: '돈부리(가츠동)', ingredients: ['돈까스', '계란', '양파', '쯔유', '즉석밥'] },
  { id: 'm77', name: '연어초밥', ingredients: ['생연어', '즉석밥', '단촛물', '와사비', '간장'] },
  { id: 'm78', name: '밀푀유나베', ingredients: ['소고기(샤브샤브용)', '배추', '깻잎', '숙주나물', '표고버섯', '쯔유'] },
  { id: 'm79', name: '쌀국수', ingredients: ['쌀국수면', '숙주나물', '양파', '차돌박이', '고수', '해선장'] },
  { id: 'm80', name: '팟타이', ingredients: ['쌀국수면', '새우', '계란', '숙주나물', '땅콩', '팟타이소스'] },
  { id: 'm81', name: '나시고랭', ingredients: ['즉석밥', '닭고기', '새우', '계란', '나시고랭소스'] },
  { id: 'm82', name: '월남쌈', ingredients: ['라이스페이퍼', '파프리카', '오이', '당근', '새우', '닭가슴살', '땅콩소스'] },
  
  // 간식 & 분식 & 기타
  { id: 'm83', name: '라볶이', ingredients: ['떡', '어묵', '라면 (봉지)', '고추장', '설탕', '대파'] },
  { id: 'm84', name: '순대', ingredients: ['순대', '간', '소금'] },
  { id: 'm85', name: '튀김모듬', ingredients: ['오징어튀김', '고구마튀김', '김말이', '야끼만두', '식용유'] },
  { id: 'm86', name: '핫도그', ingredients: ['냉동핫도그', '케첩', '머스타드'] },
  { id: 'm87', name: '콘치즈', ingredients: ['옥수수 통조림', '모짜렐라 치즈', '마요네즈', '설탕', '버터'] },
  { id: 'm88', name: '김치볶음', ingredients: ['김치', '참기름', '설탕', '깨'] },
  { id: 'm89', name: '계란찜', ingredients: ['계란', '대파', '소금', '참기름'] },
  { id: 'm90', name: '치즈스틱', ingredients: ['냉동 치즈스틱', '식용유', '케첩'] },
  { id: 'm91', name: '팝콘', ingredients: ['팝콘옥수수', '버터', '소금'] },
  { id: 'm92', name: '과일 샐러드', ingredients: ['사과', '바나나', '귤', '마요네즈', '땅콩'] },
  { id: 'm93', name: '팬케이크', ingredients: ['팬케이크가루', '우유', '계란', '버터', '메이플시럽'] },
  { id: 'm94', name: '토스트', ingredients: ['식빵', '버터', '딸기잼'] },
  { id: 'm95', name: '크로플', ingredients: ['크로와상 생지', '아이스크림', '메이플시럽'] },
  { id: 'm96', name: '군고구마', ingredients: ['고구마'] },
  { id: 'm97', name: '찐감자', ingredients: ['감자', '소금', '설탕'] },
  { id: 'm98', name: '구운계란', ingredients: ['계란', '소금'] },
  { id: 'm99', name: '카나페', ingredients: ['크래커', '치즈', '토마토'] },
  { id: 'm100', name: '그릭요거트 볼', ingredients: ['그릭요거트', '꿀', '바나나', '아몬드', '그래놀라'] }
];
